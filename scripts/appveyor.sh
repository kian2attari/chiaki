...
wget https://github.com/GyanD/codexffmpeg/releases/download/2020-11-18-git-e3081d6f4f/ffmpeg-2020-11-18-git-e3081d6f4f-full_build.zip && 7z x ffmpeg-2020-11-18-git-e3081d6f4f-full_build.zip || exit 19
cd .. || exit 1
...
cmake \
	...
	-DCMAKE_PREFIX_PATH="$APPVEYOR_BUILD_FOLDER/ffmpeg;$APPVEYOR_BUILD_FOLDER/opencv;$APPVEYOR_BUILD_FOLDER/zmq;$APPVEYOR_BUILD_FOLDER/ffmpeg-prefix;$APPVEYOR_BUILD_FOLDER/opus-prefix;$APPVEYOR_BUILD_FOLDER/openssl-1.1/x64;$QT_PATH;$SDL_ROOT" \
